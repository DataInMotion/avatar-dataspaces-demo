 ...
 */
package de.avatar.metadata.configuration;

import de.avatar.metadata.MetadataFactory;
import de.avatar.metadata.MetadataPackage;

import de.avatar.metadata.impl.MetadataPackageImpl;

import de.avatar.metadata.util.MetadataResourceFactoryImpl;
...
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"de.avatar.metadata.util.MetadataResourceFactoryImpl, org.eclipse.emf.ecore.resource.Resource$Factory\"" , "uses:=\"org.eclipse.emf.ecore.resource,de.avatar.metadata.util\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"de.avatar.metadata.MetadataFactory, org.eclipse.emf.ecore.EFactory\"" , "uses:=\"org.eclipse.emf.ecore,de.avatar.metadata\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"de.avatar.metadata.MetadataPackage, org.eclipse.emf.ecore.EPackage\"" , "uses:=\"org.eclipse.emf.ecore,de.avatar.metadata\"" })
@Capability( namespace = "osgi.service", attribute = { "objectClass:List<String>=\"org.gecko.emf.osgi.configurator.EPackageConfigurator\"" , "uses:=\"org.eclipse.emf.ecore,de.avatar.metadata\"" })
