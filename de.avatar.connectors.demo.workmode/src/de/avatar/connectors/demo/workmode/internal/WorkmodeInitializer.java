package de.avatar.connectors.demo.workmode.internal;
...
import de.avatar.connectors.demo.Namespaces;
import de.avatar.connectors.demo.configuration.AvatarCoreConfiguration;
import de.avatar.connectors.demo.workmode.Workmode;
...
public class WorkmodeInitializer {
	...
	@Activate
	public void activate(AvatarCoreConfiguration config, BundleContext context) {
	...
	@Modified
	public void modified(AvatarCoreConfiguration config, BundleContext context) {
	...
	private Dictionary<String, Object> getConditionProperties(AvatarCoreConfiguration configuration, long timestamp) {
