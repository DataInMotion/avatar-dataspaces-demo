...
//public class ISMAConnectorImplOld implements AvatarConnector {
//
//	@Reference
//	private AConnectorFactory connectorFactory;
//
//	private static final Logger LOGGER = Logger.getLogger(ISMAConnectorImplOld.class.getName());
//
...
//
//	@Activate
//	public ISMAConnectorImplOld(@Reference(target = "("+EMFNamespaces.EMF_MODEL_FILE_EXT +"=json)", cardinality = ReferenceCardinality.MANDATORY) 
