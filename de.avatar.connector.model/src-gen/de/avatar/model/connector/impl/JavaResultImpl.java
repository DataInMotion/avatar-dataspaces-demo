...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Java Result</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.avatar.model.connector.impl.JavaResultImpl#getTypeString <em>Type String</em>}</li>
 *   <li>{@link de.avatar.model.connector.impl.JavaResultImpl#getValue <em>Value</em>}</li>
 * </ul>
 *
 * @generated
 */
public class JavaResultImpl extends ResponseResultImpl implements JavaResult {
	...
	public void setTypeString(String newTypeString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AConnectorPackage.JAVA_RESULT__TYPE_STRING, oldTypeString, typeString));
	}
	...
	public void setValue(Object newValue) {
		...
		value = newValue;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AConnectorPackage.JAVA_RESULT__VALUE, oldValue, value));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AConnectorPackage.JAVA_RESULT__TYPE_STRING:
				return getTypeString();
			case AConnectorPackage.JAVA_RESULT__VALUE:
				return getValue();
		}
