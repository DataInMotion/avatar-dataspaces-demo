...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Error Status Result</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link de.avatar.status.impl.ErrorStatusResultImpl#getErrorMessage <em>Error Message</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ErrorStatusResultImpl extends StatusResultImpl implements ErrorStatusResult {
	/**
	 ...
	 * @generated
	 */
	protected ErrorStatusResultImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return StatusPackage.Literals.ERROR_STATUS_RESULT;
	}
	...
	public void setErrorMessage(String newErrorMessage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, StatusPackage.ERROR_STATUS_RESULT__ERROR_MESSAGE, oldErrorMessage, errorMessage));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case StatusPackage.ERROR_STATUS_RESULT__ERROR_MESSAGE:
