 ...
 * </p>
 * <ul>
 *   <li>{@link de.avatar.query.QWhere#getFeaturePath <em>Feature Path</em>}</li>
 *   <li>{@link de.avatar.query.QWhere#getComparator <em>Comparator</em>}</li>
 *   <li>{@link de.avatar.query.QWhere#getOperation <em>Operation</em>}</li>
 * </ul>
 *
 * @see de.avatar.query.QueryPackage#getQWhere()
 * @model abstract="true"
 * @generated
 */
@ProviderType
public interface QWhere extends EObject {
	 ...
	 * @see de.avatar.query.QueryPackage#getQWhere_FeaturePath()
	...
	/**
	 * Sets the value of the '{@link de.avatar.query.QWhere#getFeaturePath <em>Feature Path</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * It is bidirectional and its opposite is '{@link de.avatar.query.Comparator#getWhere <em>Where</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * <!-- begin-model-doc -->
	 ...
	 * @see de.avatar.query.QueryPackage#getQWhere_Comparator()
	...
	/**
	 * Sets the value of the '{@link de.avatar.query.QWhere#getComparator <em>Comparator</em>}' containment reference.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
