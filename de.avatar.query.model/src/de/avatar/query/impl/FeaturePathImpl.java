 ...
 * </p>
 * <ul>
 *   <li>{@link de.avatar.query.impl.FeaturePathImpl#getName <em>Name</em>}</li>
 *   <li>{@link de.avatar.query.impl.FeaturePathImpl#getFeature <em>Feature</em>}</li>
 * </ul>
 *
 * @generated
 */
public class FeaturePathImpl extends MinimalEObjectImpl.Container implements FeaturePath {
	...
	protected EClass eStaticClass() {
		return QueryPackage.Literals.FEATURE_PATH;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, QueryPackage.FEATURE_PATH__NAME, oldName, name));
	}
	...
	public EList<EStructuralFeature> getFeature() {
		if (feature == null) {
			feature = new EObjectResolvingEList<EStructuralFeature>(EStructuralFeature.class, this, QueryPackage.FEATURE_PATH__FEATURE);
		}
		return feature;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case QueryPackage.FEATURE_PATH__NAME:
				return getName();
			case QueryPackage.FEATURE_PATH__FEATURE:
				return getFeature();
		}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case QueryPackage.FEATURE_PATH___GET_VALUE__EOBJECT:
				return getValue((EObject)arguments.get(0));
			case QueryPackage.FEATURE_PATH___IS_VALID__EOBJECT:
