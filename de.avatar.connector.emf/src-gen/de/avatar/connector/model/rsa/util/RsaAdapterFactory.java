...
public class RsaAdapterFactory extends AdapterFactoryImpl {
	...
	protected RsaSwitch<Adapter> modelSwitch =
		new RsaSwitch<Adapter>() {
			@Override
			public Adapter caseRsaRequest(RsaRequest object) {
				return createRsaRequestAdapter();
			}
			@Override
			...
			@Override
			public Adapter caseRsaResponse(RsaResponse object) {
				return createRsaResponseAdapter();
			}
			@Override
			public Adapter caseRsaObject(RsaObject object) {
				return createRsaObjectAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.avatar.connector.model.rsa.RsaRequest <em>Request</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.avatar.connector.model.rsa.RequestParameter <em>Request Parameter</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.avatar.connector.model.rsa.RsaResponse <em>Response</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link de.avatar.connector.model.rsa.RsaObject <em>Object</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
