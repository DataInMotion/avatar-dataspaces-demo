...
public class RsaSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case RsaPackage.RSA_REQUEST: {
				RsaRequest rsaRequest = (RsaRequest)theEObject;
				T result = caseRsaRequest(rsaRequest);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RsaPackage.REQUEST_PARAMETER: {
				RequestParameter requestParameter = (RequestParameter)theEObject;
				T result = caseRequestParameter(requestParameter);
				if (result == null) result = caseRsaObject(requestParameter);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RsaPackage.RSA_RESPONSE: {
				RsaResponse rsaResponse = (RsaResponse)theEObject;
				T result = caseRsaResponse(rsaResponse);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case RsaPackage.RSA_OBJECT: {
				RsaObject rsaObject = (RsaObject)theEObject;
				T result = caseRsaObject(rsaObject);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	 ...
	 * @generated
	 */
	public T caseRsaRequest(RsaRequest object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseRsaResponse(RsaResponse object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseRsaObject(RsaObject object) {
		return null;
	}
